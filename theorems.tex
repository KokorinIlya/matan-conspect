	...
	\emph{Доказательство:}
		\begin{itemize}
			...
			\begin{enumerate}
				...
				$\exists$ последовательсность $f_1 \leq f_2 \leq \dots \in P : \int\limits_X f_n d\mu \rightarrow I$
				\item
				Рассмотрим $p_1, p_2, \dots : \int\limits_X p_n \rightarrow I$, а также $f_n = max(p_1 \dots p_n) \in P$
				\item
...
\begin{enumerate}
	...
	$$ \mu X_n(\epsilon) \overset{\textcolor{red}{\text{Схера ли?}}}{=} \int\limits_{X_n} (\frac{f_n - f}{\epsilon})^p  =
