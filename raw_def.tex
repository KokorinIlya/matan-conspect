...
\begin{document}
	...
	$\{f_n\}_{n \geqslant 1} \subset L^p(X, \mu)$ называется фундаментальной в $L^p(X, \mu)$>, если $\|f_n - f_k\|_p \to 0$ при $k, n \to \infty$, т.е.
	: $\forall \varepsilon > 0 \ \exists N : \|f_n - f_k\| < \varepsilon$ при $k, n > N$
